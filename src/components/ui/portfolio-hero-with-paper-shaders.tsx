  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex">
      ...
      >
        ...
        {/* Header */}
        <div className="mb-12">
          <h1 className="text-lg font-normal mb-8">maeski.cv</h1>
          <div className="mb-8">
            <h2 className="text-lg font-normal">MICHAEL E. QUIROS</h2>
        ...
        <div className="mb-12 space-y-1">
          <div className="flex">
            ...
            <span className="mx-2">Senior Software Engineer</span>
        ...
        <div className="absolute bottom-8 left-8">
          <div className="flex space-x-4 text-lg font-mono">
            <a href="https://github.com/maeskidev" target="_blank" rel="noopener noreferrer" className="hover:underline">GitHub</a>
            <a href="https://www.linkedin.com/in/michaelquiros/" target="_blank" rel="noopener noreferrer" className="hover:underline">LinkedIn</a>
